              ...
              <div className="d-flex">
                <ul className="navbar-nav me-auto mb-2 mb-lg-0">
                  ...
                  <li className="nav-item dropdown">
                    <img
                      src={`https://nathannhan.github.io/asset/du-an-congty/language.png`}
                      alt=""
          ...
          <div className="container text-center text-md-start mt-5 text-white">
            ...
            <div className="row mt-3">
              ...
              <div className="col-lg-6 col-12 col-sm-12 col-md-12  mb-4 mb-md-0 mx-auto mb-4 text-white">
                {/* Content */}
                <img src={`https://nathannhan.github.io/asset/du-an-congty/logo_footer.png`} alt="" className="mb-4" />
              ...
              <div className="col-lg-3 col-12 col-sm-12 col-md-12  mx-auto mb-md-0 mb-4">
                ...
                <p className="text-white color-gray">
                  <img
                    src={`https://nathannhan.github.io/asset/du-an-congty/phonecall_footer.png`}
                    className="icon-footer"
                  />
                  Phone <br /> (021) 29517888
                </p>
                <p className="text-white color-gray">
                  <img src={`https://nathannhan.github.io/asset/du-an-congty/mail_footer.png`} className="icon-footer" />
                  Email <br />
                  Johny@Semestamedika.com
                </p>
                <p className="text-white color-gray">
                  <img
                    src={`https://nathannhan.github.io/asset/du-an-congty/location_footer.png`}
                    className="icon-footer"
                  />
                  Address
